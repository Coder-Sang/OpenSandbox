...
class BatchSandboxProvider(WorkloadProvider):
    ...
    def create_workload(
        ...
        if extensions.get("poolRef"):
            ...
            return self._create_workload_from_pool(
                ...
                forced_bwrap=extensions.get(INTERNAL_BWRAP_EXTENSION) == "enable",
            )
        ...
        pod_volumes = [{"name": "opensandbox-bin", "emptyDir": {}}]
    ...
    def _build_task_template(
        ...
        if forced_bwrap:
            env = {
                "EXECD_INIT": "1",
                "EXECD_RUNTIME_INIT": "1",
                "EXECD_POOL_BWRAP": "1",
            }
        elif self.execd_run_as_init:
